...
var Carousel = (function(_Component) {
  ...
  function Carousel(props) {
    ...
    _this.onSwipeMove = function(delta, event) {
      ...
      var finalBoundry = _this.props.infiniteLoop
        ? _this.getPosition(childrenLength - 1) - 100
        : _this.getPosition(childrenLength - 1);
      ...
      var position =
        currentPosition + 100 / (_this.state.itemSize / handledDelta);
      if (_this.props.infiniteLoop) {
        ...
        if (_this.state.selectedItem === 0 && position > -100) {
          ...
          _this.state.selectedItem === childrenLength - 1 &&
          position < -childrenLength * 100
        ) {
          position += childrenLength * 100;
        }
          ...
          function() {
            if (oldPosition < 0) {
              if (_this.props.centerMode && _this.props.axis === "horizontal") {
                _this.setPosition(
                  "-" +
                    ((lastPosition + 2) * _this.props.centerSlidePercentage -
                      (100 - _this.props.centerSlidePercentage) / 2) +
                    "%",
                  true
                );
              } else {
